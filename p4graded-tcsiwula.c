/*
***Correctness***               
Correctly uses C library qsort function 5   /   5   
Uses block partition of the input list  5   /   5   
Butterfly strucutres correct    5   /   5   
Merge-splits correct    5   /   5   
Accept correct command line format  5   /   5   
Input list: proc 0 reads in the list and calls MPI_Scatter  5   /   5   
Generate list: process 0 generates the list with seed 1 and max = 1M, and calls MPI_Scatter 5   /   5   
Output: original list and sorted list   5   /   5   
                
Test n = 16, p = 1  5   /   5   
Test n = 16, p = 2  5   /   5   
Test n = 16, p = 4  5   /   5   
Test n = 16, p = 4, with DEBUG flag set 5   /   5   
...
***Quality***               
Used MPI_Sendrecv for exchanging data amoung processes  3   /   3   
Should not) allocate more memory than necessary 2   /   5   
(Should not) use for loop to copy merged list into the orignal list 2   /   2   
###Total Quality###     7       10
